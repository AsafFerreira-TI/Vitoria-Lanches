...
<body>
    ...
    <form method="POST" style='margin-left: 500px;'>
        ...
        <button><a href='minha_conta_cliente.php' style='color: black;'>Voltar</a></button><br>
    </form>
    ...
    <?php
        if(isset($_POST['mudar_senha'])){
            ...
            if($senha_atual == $_SESSION['user']['senha'] && $nova_senha == $nova_senha_confirm){
                include("../../database/config.php");
                $sql_upd_psswd = "UPDATE TB_USUARIO SET SENHA_TB_USUARIO = '$nova_senha' WHERE ID_TB_USUARIO = '".$_SESSION['user']['id_usuario']."';";
